    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apellido', models.CharField(max_length=100, null=True, verbose_name='Apellidos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(db_index=True, max_length=70, verbose_name='Correo Electrónico')),
                ('nombre', models.CharField(max_length=100, null=True, verbose_name='Nombres')),
                ('apellido', models.CharField(max_length=100, null=True, verbose_name='Apellidos')),
                ('imagen', models.TextField(blank=True, max_length=100, null=True, verbose_name='Imagen de Perfil')),
                ('usuario_activo', models.BooleanField(default=True)),
                ('usuario_administrador', models.BooleanField(default=False)),
